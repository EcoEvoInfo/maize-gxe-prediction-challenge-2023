...
reference to B73_RefGen_v4 and then to Zm-B73-REFERENCE-NAM-5.0. Of 7498 sites in Table S6, only 209 were identified in `5_Genotype_Data_All_Years.vcf` file released with the competition data after light filtering and imputation. Realignment to current reference genome may be needed to develop a more comprehensive SNP list.
